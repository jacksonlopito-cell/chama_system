-- ============================================================
-- Migration 005: Homepage Sections (CMS)
-- Creates page_sections table and seeds default content.
...
-- Seed default sections (idempotent via INSERT IGNORE)
...
-- Add manage_homepage permission (idempotent)
INSERT IGNORE INTO permissions (name, slug, module) VALUES ('Manage Homepage', 'manage_homepage', 'settings');

-- Assign to Super Admin role if not already assigned
INSERT IGNORE INTO role_permissions (role_id, permission_id)
SELECT 1, id FROM permissions WHERE slug = 'manage_homepage';
